        ...
        <>  
            ...
            <div className={classes.container}>
                <Grid container className={classes.header}>
                    <img item className={classes.photo} src={dairyImage} alt='dairy logo'/>
                    <h2 item className={classes.header} >Dairy</h2>
                    <OptionChips item options={dairyOptions} setOptions = {setDairy} />
                </Grid>
            </div>
            <div className={classes.container}>
                <Grid container className={classes.header}>
                    <img item className={classes.photo} src={produceImage} alt='produce logo'/>
                    <h2 item className={classes.header}>Produce</h2>
                    <OptionChips item options={produceOptions} setOptions = {setProduce}/>
                </Grid>
            </div>
            <div className={classes.container}>
                <Grid container className={classes.header}>
                    <img item className={classes.photo} src={bakingImage} alt='baking logo'/>
                    <h2 item className={classes.header}>Baking & Grains</h2>
